...
public class FitnessCounter {
	 ...
	 *
	 * @param population
	 *            populacja osobników dla której liczymy poziom dopasowania
	 */
	...
	/**
	 * Metoda ta zwraca wartosc wspó³czynnika dostosowania
	 *
	 */
	...
	/**
	 * Metoda ta wypisuje wartoœci wspó³czynników komfortu poszczególnych osobników
	 * z danej populacji.
	 */
	public void writePopulationComfortFactors() {
		...
		for (int i = 0; i < population.getIndividualsPopulation().size(); i++) {
			...
			System.out.println("Komfort kosztów" + "(max[" + (100 * costComfortWeight) + " pkt]): "
					+ tmp.getCostComfort() + " pkt");
			System.out.println("Komfort sto³ów" + "(max[" + (100 * tablesComfortWeight) + " pkt]): "
					+ tmp.getTablesComfort() + " pkt");
			System.out.println("Komfort oœwietlenia" + "(max[" + (100 * lightningComfortWeight) + " pkt]): "
			...
			System.out.println("Maksymalna mo¿liwa suma punktów komfortu osobnika: " + solution + " pkt");
	...
	/**
	 * Metoda ta wylicza wartoœæ wspó³czynnika komfortu poszczególnych elementów
	 * sto³ówki dla ca³ej populacji, wykorzystuj¹c do tego pozosta³e metody z tej
	 * klasy.
	 */
	...
	/**
	 * Metoda ta liczy komfort miejsc siedz¹cych wdanej sto³ówce.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	private int calculateSeatsComfort(Individual individual) {
		...
		a = 0;
		b = 0;
		int maxTable = 0;// maksymalna liczba osóba jakie mog¹ usi¹œæ przy tym stole
	...
	/**
	 * Metoda ta oblicza komfort wynikaj¹cy z kosztu wykorzystanych w sto³ówce
	 * obiektów. Punkty te obliczane s¹ na zasadzie porównania ich kosztu z kosztem
	 * najtañszego projektu sto³ówki.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	/**
	 * Metoda ta oblicza komfort wynikaj¹cy z wielkoœci wybranych sto³ów i ich
	 * liczby.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	/**
	 * Metoda ta oblicza komfort wynikaj¹cy z oœwietlenia sto³ówki.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	/**
	 * Metoda ta oblicza komfort ustawienia w sto³ówce sklepiku. Komfort sklepiku
	 * obliczany jest wy³¹cznie na podstawie jego odleg³oœci od drzwi wyjœciowych.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	/**
	 * Metoda ta oblicza komfort ustawienia okien w sto³ówce. Komfort jest tym
	 * wiêkszy, im wiêksz¹ powierzchniê pokrywaj¹ okna.
	 *
	 * @param individual
	 *            osobnik w którym zapisaæ punkty komfortu
	...
	/**
	 * Metoda ta znajduje najni¿szy koszt sto³ówki spoœród osobników danej
	 * populacji.
	 *
	 * @return najni¿szy koszt skonstruowania sto³ówki w danej populacji
	 */
	...
	/**
	 * Metoda ta znajduje najwiêksz¹ liczbê sto³ów spoœród osobników danej
	 * populacji.
	 *
	 * @return najwiêksza liczba sto³ów w danej populacji
	 */
	...
	/**
	 * Metoda ta znajduje najwiêksz¹ liczbê miejsc siedz¹cych spoœród osobników
	 * danej populacji.
	 *
	 * @return najwiêksza liczba miejsc siedz¹cych w danej populacji
	 */
